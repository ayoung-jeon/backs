package com.sparta.backs.global.fillter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.sparta.backs.domain.user.dto.LoginRequestDto;
import com.sparta.backs.global.jwt.JwtUtil;
import com.sparta.backs.global.secuity.UserDetailsImpl;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        // CORS 헤더를 설정
        response.setHeader("Access-Control-Allow-Origin", "http://localhost:3000, https://clone-project-insta.vercel.app");
