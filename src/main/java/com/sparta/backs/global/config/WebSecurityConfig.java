package com.sparta.backs.global.config;

import com.sparta.backs.global.fillter.JwtAuthenticationFilter;
import com.sparta.backs.global.fillter.JwtAuthorizationFilter;
import com.sparta.backs.global.jwt.JwtAuthenticationEntryPoint;
import com.sparta.backs.global.jwt.JwtUtil;
import com.sparta.backs.global.secuity.UserDetailsServiceImpl;
...
//                        .requestMatchers("/api/users", "/api/users/**").permitAll() // '/api/rollingpapers/'로 시작하는 요청 모두 접근 허가
                                .requestMatchers(HttpMethod.GET, "/api/posts/**").permitAll() // GET 요청에 대해 허용
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000, https://clone-project-insta.vercel.app"));
